...
func updateVaultAddon(d *schema.ResourceData, m interface{}, clusterTypeID client.ID) error {
	...
	vaultErr := updateVaultAuth(apiClient, clusterTypeID, "VaultKubernetesAuthSpec", changes)
	if vaultErr != nil {
		return vaultErr
	}
	return nil
...
func updateVaultAuth(apiClient client.Client, id client.ID, descendant string, changes map[string]interface{}) error {
